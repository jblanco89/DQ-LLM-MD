...
task2identifier = {"relevance": root_dir + "trained adapters/relevance",
                   "fact": root_dir + "trained adapters/fact",
                #    "opinion": root_dir + "trained adapters/opinion",
                #    "justification": root_dir + "trained adapters/justification",
                #    "solproposal": root_dir + "trained adapters/solproposal",
                #    "addknowledge": root_dir + "trained adapters/addknowledge",
                #    "question": root_dir + "trained adapters/question",

                #    "refusers": root_dir + "trained adapters/refusers",
                #    "refmedium": root_dir + "trained adapters/refmedium",
                #    "refcontents": root_dir + "trained adapters/refcontents",
